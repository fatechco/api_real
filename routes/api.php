...
//    Route::get('/login/{provider}',                   [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'rest'], function () {
        ...
        Route::get('search-many',                 [Rest\FilterController::class, 'searchMany']);
        ...
        /* Auctions */
        Route::apiResource('auctions', Rest\AuctionController::class);
        Route::get('auction/users', [Rest\AuctionController::class, 'users']);
        Route::get('auction/questions', [Rest\AuctionController::class, 'questions']);
    });
    ...
    Route::group(['prefix' => 'dashboard', 'middleware' => ['sanctum.check']], function () {
        ...
        Route::group(['prefix' => 'user', 'middleware' => ['sanctum.check'], 'as' => 'user.'], function () {
            ...
            Route::get('notify/send',                           [User\ProfileController::class, 'notifySend']);
            ...
            Route::get('export/booking/{id}/pdf',               [User\ExportController::class, 'bookingExportPDF']);
            ...
            Route::post('gift-carts/send',       [User\GiftCartController::class, 'send']);
        ...
        Route::group(['prefix' => 'master', 'middleware' => ['sanctum.check', 'role:master'], 'as' => 'master.'], function () {
            ...
            Route::get('auction/{id}/question', [User\AuctionController::class, 'storeQuestion']);
        });
        ...
        Route::group(['prefix' => 'seller', 'middleware' => ['sanctum.check', 'role:seller|moderator|admin'], 'as' => 'seller.'], function () {
            ...
            Route::group(['prefix' => 'report'], function () {
                Route::get('performance-dashboard', [Seller\ReportController::class, 'performanceDashboard']);
            });
            ...
            Route::apiResource('reviews', Seller\ReviewController::class);
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['sanctum.check', 'role:admin|manager'], 'as' => 'admin.'], function () {
            ...
            Route::group(['prefix' => 'report'], function () {
                ...
                Route::get('sales-list',                [Admin\ReportController::class, 'salesList']);
                Route::get('sales-log-detail',          [Admin\ReportController::class, 'salesLogDetail']);
                Route::get('gift-card-list',            [Admin\ReportController::class, 'giftCardList']);
                Route::get('membership-list',           [Admin\ReportController::class, 'membershipList']);
                Route::get('payments-summary',          [Admin\ReportController::class, 'paymentsSummary']);
                Route::get('payment-transactions',      [Admin\ReportController::class, 'paymentTransactions']);
                Route::get('finance-summary',           [Admin\ReportController::class, 'financeSummary']);
                Route::get('appointments-summary',      [Admin\ReportController::class, 'appointmentsSummary']);
                Route::get('working-hours',             [Admin\ReportController::class, 'workingHours']);
            });
            ...
            Route::post('payment-to-partners/bookings/store/many',  [Admin\PaymentToPartnerController::class, 'bookingStoreMany']);
            ...
            Route::get('ai-translation/chart', [Admin\AITranslationController::class, 'chart']);
        });

    });

    Route::group(['prefix' => 'webhook'], function () {
        Route::any('payu/payment',         [Payment\PayuController::class,        'paymentWebHook']);
        Route::any('stripe/payment',       [Payment\StripeController::class,      'paymentWebHook']);
        Route::any('orange/payment',       [Payment\OrangeController::class,      'paymentWebHook']);
        Route::any('mtn/payment',          [Payment\MtnController::class,         'paymentWebHook']);
