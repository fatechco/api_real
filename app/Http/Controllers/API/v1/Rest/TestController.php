...
class TestController extends Controller
{
    ...
    {
        $translations = json_decode(Storage::get('translation_en.json'));
        ...
        dd('success');
//        $user = User::where('email', 'owner@githubit.com')->first();
//
//        dd(
//            $this->sendNotification(
//                $user,
//                ['edQkXKy8jQSNCoWBlizFP9:APA91bHjjuD0Xi9aTdcrLlgtZIBJ-HZfAL3vcyD0l-ymdL0IZaSsWYfesO4XwTL7KEpjmjHgOpONd7VCbreC8xgOt_ioQSR1LAUqwTsn7fKEdUk3SZMvFOYeynLydpGMfYIff_Cfnp9s'],
//                'test',
//                'test',
//                [
//                    'id' => 1,
