...
class DashboardRepository extends CoreRepository
{
    ...
    public function productsStatistic(array $filter = []): Paginator
    {
        ...
        return Stock::with([
            ...
            'stockExtras.value',
            'stockExtras.group.translation' => function ($q) {
    ...
    public function salesReport(array $filter): array
    {
        ...
        foreach ($deliveredOrders as $order) {
            ...
            $deliveryFee   += $order->sum('delivery_fee');
            $couponPrice   += $order->sum('coupon_price');
            $tips          += $order->sum('tips');
        }
        ...
        return [
            'card' => [
                ...
                'seller_fee'   => $totalPrice - $serviceFee - $commissionFee - $deliveryFee - $couponPrice - $tips,
