    ...
    public function create(Booking $booking, string $type, ?string $locale = 'en', ?array $data = []): void
    {
        ...
        switch ($type) {
            ...
            case 'update':
                ...
                if ( // reschedule
                    isset($data['start_date']) && date('Y-m-d H:i', strtotime($booking->start_date)) !== $data['start_date'] ||
                    isset($data['end_date'])   && date('Y-m-d H:i', strtotime($booking->end_date))   !== $data['end_date']
                ) {

                    $startDate = date('Y-m-d H:i', strtotime($booking->start_date));
                    $endDate   = date('Y-m-d H:i', strtotime($booking->end_date));
